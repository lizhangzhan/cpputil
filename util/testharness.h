...
// Return the directory to use for tempory storage
extern std::string TmpDir();

// Return a randomization seed for this run. Typically returns
// the same number on repeated invocations of this binary, but
// automated runs may be able to vary the seed
